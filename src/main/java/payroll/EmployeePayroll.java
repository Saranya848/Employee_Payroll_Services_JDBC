...
public class EmployeePayroll {
    ...
    public EmployeePayroll(String name, LocalDate startDate, int salary, int id) {
        this.name = name;
    ...
    public ArrayList<EmployeePayroll> readData(String url, String userName, String password) {
        ArrayList<EmployeePayroll> listOfDataObjects = new ArrayList<EmployeePayroll>();
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                listOfDataObjects.add(new EmployeePayroll(name, startdate, salary, id));
            }
            connection.close();
    ...
    public static void main(String Args[]) {
        ...
        EmployeePayroll.connectToDatabase(jdbcURL, userName, password);
